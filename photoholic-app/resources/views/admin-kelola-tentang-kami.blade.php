...
<body>
  <div class="phone">
    ...
    <div class="status-bar">
      ...
      <img src="{{ asset('asset/pelanggan/beranda/icons.png') }}" class="status-icons" alt="Icon status">
    </div>
    ...
    >
      ...
      <section class="about-admin-intro-card">
        <div class="about-admin-intro-text">
          <p>
            Ubah teks yang muncul pada halaman
            <strong>Tentang Kami</strong> di aplikasi pengguna.
          </p>
        </div>
      </section>
      ...
      <section class="about-admin-section">
        ...
        <textarea
          name="description"
          class="about-admin-textarea"
          placeholder="Tulis deskripsi singkat tentang Photoholic..."
        >{{ old('description', $about_pages->description ?? '') }}</textarea>
      </section>
      ...
      <section class="about-admin-section">
        ...
        <textarea
          name="visi"
          class="about-admin-textarea"
          placeholder="Tulis visi Photoholic..."
        >{{ old('vision', $about_pages->vision ?? '') }}</textarea>
      </section>
      ...
      <section class="about-admin-section">
        ...
        <textarea
          name="misi"
          class="about-admin-textarea"
          placeholder="Tulis misi Photoholic (boleh poin per baris)..."
        >{{ old('mission', $about_pages->mission ?? '') }}</textarea>
      </section>
      ...
      <section class="about-admin-section">
        ...
        <textarea
          name="kontak"
          class="about-admin-textarea"
          placeholder="Tulis informasi kontak..."
        >{{ old('contact', $about_pages->contact ?? '') }}</textarea>
      </section>

      <!-- BUTTON -->
      <div class="about-admin-actions">
        <button type="submit" class="btn-save-about">
          Simpan Perubahan
        </button>
        <button
          type="button"
          class="btn-cancel-about"
